...
**Repositório:** [SiteCyberJagua](https://github.com/GusttavoJaguar/SiteCyberJaguar)[r
](https://github.com/GusttavoJaguar/SiteCyberJaguar)
**Link deploy: **[https://sitecyberjaguar.onrender.com/](https://sitecyberjaguar.onrender.com/)** **
...
| **Ruby on Rails (Rails)** | Framework web full-stack utilizado para estruturar a aplicação. |
| **Action Mailer** | Componente nativo do Rails utilizado para compor, enviar e receber e-mails a partir da aplicação. |
| **HTML/CSS/JavaScript** | Tecnologias de frontend utilizadas para construir a interface do usuário (formulário de contato). |
